                ...
                <div key={item.id} className={`p-3 sm:p-4 border-b border-slate-200 dark:border-slate-700 ${
                  ...
                  <div className="flex gap-2 sm:gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 mt-0.5 sm:mt-1">{formatPrice(itemPrice)}</p>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <p className="font-semibold text-slate-900 dark:text-white text-sm sm:text-base">{formatPrice(itemTotal)}</p>
                    </div>
                  </div>
                </div>
              )
              ...
              <TableBody>
                {cart.map((item, index) => {
                  ...
                  const getPriceBreakdown = () => {
                    ...
                    return `Avg: ${formatPrice(averagePrice)} per item`
                  }
                  ...
                  return (
                    ...
                    <TableCell className="text-slate-700 dark:text-slate-300">
                      {(() => {
                        ...
                        return formatPrice(parseFloat(displayPrice));
                      })()}
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell className="text-right font-semibold text-slate-900 dark:text-white">
                      {(() => {
                        ...
                        return formatPrice(parseFloat(totalPrice));
                      })()}
                    </TableCell>
                  </TableRow>
                  )
